...
public class LocatorPage extends Parent{
    ...
    @FindBy(xpath = "//*[text()='Men']")                                                                private WebElement Men;
    @FindBy(xpath = "(//span[text()='Tops'])[2]")                                                       private WebElement Tops;
    @FindBy(xpath = "(//span[text()='Jackets'])[2]")                                                    private WebElement jaket;
    @FindBy(xpath = "//ol[@class='products list items product-items']//li")                             private List<WebElement> JaketsList;
    ...
    public List<WebElement> getJaketsList(DataTable dataTable) {return JaketsList;}
